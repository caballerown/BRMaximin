%The following code tests the Prisoner Dilemma game under varying
...
%% Static Payoff Array - Prisoner's Dilemma
...
%% Check Point Estimate Value of Prisoner's Dilemma
max_k=40;
tau_LB= 1.49999;
tau_UB = 1.500;
tau_inc=1.5-1.49999;

[value]=CogHierExpM(payoffarray, tau_LB, tau_UB, tau_inc, max_k)
plot(value{1})
